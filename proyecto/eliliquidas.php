...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST["eliminar"])) {
    ...
    $sql_delete = "DELETE FROM liquidas WHERE id = $id_producto";
...
$sql_select = "SELECT * FROM liquidas";
                    ...
                    <tbody>
                        <?php while ($fila = mysqli_fetch_assoc($resultado)) { ?>
                            <tr>
                                ...
                                <td>
                                    <a href="ediliquidas.php?id=<?php echo $fila['id']; ?>" class="btn btn-primary">Editar</a>
...
<button type="button" class="btn btn-outline-secondary ml-2"
        onclick="location.href='adliquidas.php'">Volver</button>
