...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST["eliminar"])) {
    ...
    $sql_delete = "DELETE FROM gpu WHERE id = $id_producto";
                    ...
                    <tbody>
                        <?php while ($fila = mysqli_fetch_assoc($resultado)) { ?>
                            <tr>
                                ...
                                <td>
                                    <a href="edigpu.php?id=<?php echo $fila['id']; ?>" class="btn btn-primary">Editar</a>
...
<button type="button" class="btn btn-outline-secondary ml-2"
        onclick="location.href='adgpu.php'">Volver</button>
