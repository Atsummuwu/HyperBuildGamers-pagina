...
<body>
    <div class="container">
        <h1>Agregar Discos o SSD</h1>
        <form action="addiscosh.php" method="POST" enctype="multipart/form-data">
        ...
        onclick="location.href='productos.php'">volver</button>

            <button type="button" class="btn btn-outline-secondary ml-2"
        onclick="location.href='elidiscos.php'">eliminar/editar</button>
