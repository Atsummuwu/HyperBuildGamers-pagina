...
if (isset($_GET['id']) && !empty($_GET['id'])) {
    ...
    $sql_select = "SELECT * FROM coolers WHERE id = $id_producto";
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql_update = "UPDATE coolers SET marca = '$marca', nombre = '$nombre', descripcion = '$descripcion', precio = '$precio', stock = '$stock' WHERE id = $id_producto";
...
<body>
    <div class="container">
        ...
        onclick="location.href='elicoolers.php'">Volver</button>
