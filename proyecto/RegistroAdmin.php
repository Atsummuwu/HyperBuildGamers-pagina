...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  ...
  $sql = "INSERT INTO Admins (nombres, apellidos, rut, fecha_nacimiento, correo_electronico, contrasena) 
  ...
  <nav class="navbar navbar-expand-lg navbar-light bg-light">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav ml-auto">
        <li class="nav-item">
          <a class="nav-link" href="InicioSesionAdmin.html">Iniciar Sesión</a>
        </li>
      </ul>
    </div>
  </nav>
  ...
  document.getElementById('togglePassword').addEventListener('click', function() {
    ...
    if (passwordInput.type === 'password') {
      ...
      <button type="button" class="btn btn-outline-secondary ml-2"
        onclick="location.href='inicioSesionAdmin.php'">Volver</button>
