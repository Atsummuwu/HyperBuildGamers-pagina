...
if (isset($_GET['id']) && !empty($_GET['id'])) {
    ...
    $sql_select = "SELECT * FROM monitores WHERE id = $id_producto";
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql_update = "UPDATE monitores SET marca = '$marca', nombre = '$nombre', descripcion = '$descripcion', precio = '$precio', stock = '$stock' WHERE id = $id_producto";
...
<body>
    <div class="container">
        ...
        onclick="location.href='elimonitores.php'">Volver</button>
