...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "SELECT id, nombres, correo_electronico, contrasena FROM usuarios WHERE correo_electronico = '$correo'";
    ...
    <div class="container mt-5">
        ...
        <form id="loginForm" method="post" action="InicioSesion.php">
            ...
            <button type="button" class="btn btn-outline-secondary ml-2"
                ...
                <button type="button" class="btn btn-outline-secondary ml-2"
                onclick="location.href='InicioSesionAdmin.php'">Eres funcionario? Entra aca</button>
